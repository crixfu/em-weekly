...
function renderEbmStats(a) {
  ...
  const rows = visible.map(f => `
    <tr>
      <td style="padding:8px 12px; font-weight:700; color:#2c3e50; white-space:nowrap; width:1%; border-bottom:1px solid #eef0f3;">${f.label}</td>
      <td style="padding:8px 12px; color:#2980b9; font-weight:600; white-space:nowrap; border-bottom:1px solid #eef0f3;">${stats[f.key]}</td>
      <td style="padding:8px 12px; color:#636e72; font-size:13px; border-bottom:1px solid #eef0f3;">${f.desc}</td>
    </tr>
  `).join('');
    ...
    <div class="section">
      ...
      <div class="section-body">
        <div style="overflow-x:auto;">
          <table style="width:100%; border-collapse:collapse; font-size:14px; background:#fafbfc; border-radius:8px; overflow:hidden; border:1px solid #eef0f3;">
            <thead>
              <tr style="background:#eef0f3;">
                <th style="padding:8px 12px; text-align:left; color:#636e72; font-size:12px; font-weight:600; letter-spacing:0.5px;">指標</th>
                <th style="padding:8px 12px; text-align:left; color:#636e72; font-size:12px; font-weight:600; letter-spacing:0.5px;">數值</th>
                <th style="padding:8px 12px; text-align:left; color:#636e72; font-size:12px; font-weight:600; letter-spacing:0.5px;">說明</th>
              </tr>
            </thead>
            <tbody>
              ${rows}
